...
namespace Phoenix.Controllers
{
    ...
    public class TicketTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CompanyId")] TicketType ticketType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CompanyId")] TicketType ticketType)
        {
            if (id != ticketType.Id)
            {
                return NotFound();
