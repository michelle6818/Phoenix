...
namespace Phoenix.Controllers
{
    ...
    public class TicketPrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CompanyId")] TicketPriority ticketPriority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CompanyId")] TicketPriority ticketPriority)
        {
