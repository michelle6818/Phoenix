...
namespace Phoenix.Controllers
{
    ...
    public class TicketStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CompanyId")] TicketStatus ticketStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CompanyId")] TicketStatus ticketStatus)
        {
